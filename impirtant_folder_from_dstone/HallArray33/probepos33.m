...
%reordered 041912 by axl for the actual probe ordering!

% added comments and corrections by Artur Perevalov in 2019 
...
phi=[phi_HLS;phi_MLS;phi_EQ;phi_MLN;phi_HLN];  %changed by Axl - was upside down
...
%% additions for two new polar probes: when were these added? sometime in
%April 2016, or earlier?
r(1,32:33) = 1.105424205;  % THIS ONE IS WRONG (it is probably meters); comments by Artur
% Artur Perevalov 08/2019 comment: 1.1 is outside while these probes are inside?
% assuming the sticks are ~30cm long I'd correct the radius to 1.46m-0.3m = 1.16m
% and it is in units of core mantle boundary it should be 1.16/1.46 = 0.7945
r(1,32:33) = 0.7945;

% r(1,32:33) = 1.105424205;

phi_PLN = [75; 225];
theta_PLN = [81.8; 81.8] - 90;
phi = [phi; phi_PLN];
theta = [theta; theta_PLN];
